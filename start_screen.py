...
class StartScreen(Screen):
 ...
 # Define button colors
        ...
        self.quit_rct = pygame.Rect(button_x, quit_button_y, button_width, button_height)
    ...
    def draw(self):
        ...
        # Draw buttons
        pygame.draw.rect(self.screen, self.start_color, self.start_rct)
        pygame.draw.rect(self.screen, self.quit_color, self.quit_rct)
        
        # Add text to buttons
        font = pygame.font.Font(None, 36)
        start_text = font.render("Start", True, (255, 255, 255))  # White text
        quit_text = font.render("Quit", True, (255, 255, 255))    # White text
        self.screen.blit(start_text, (self.start_rct.x + 20, self.start_rct.y + 10))
        self.screen.blit(quit_text, (self.quit_rct.x + 30, self.quit_rct.y + 10))
